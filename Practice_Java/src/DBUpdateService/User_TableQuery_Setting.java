 ...
 * @author Arvin
 */
public interface User_TableQuery_Setting extends DBQuery_Setting {
    ...
    public static final String QUERY_CREATE_TABLE = "CREATE TABLE IF NOT EXISTS " + DATABASE_NAME + "." + TABLE_NAME
            + "(" + TABLE_COLUMN_NAME_USERID + " bigint NOT NULL AUTO_INCREMENT, "
            + TABLE_COLUMN_NAME_USERNAME + " varchar(255) NOT NULL, "
            + TABLE_COLUMN_NAME_USERAGE + " int NOT NULL, " + TABLE_COLUMN_NAME_USERHEIGHT + " double NOT NULL, "
            + TABLE_COLUMN_NAME_USERWEIGHT + " double NOT NULL, primary key(" + TABLE_COLUMN_NAME_USERID + "))";
